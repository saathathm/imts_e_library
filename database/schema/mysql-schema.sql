...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_book_id_foreign` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `migrations` VALUES (17,'2023_04_02_121213_create_admins_table',1);
INSERT INTO `migrations` VALUES (18,'2023_04_04_091744_create_users_table',1);
INSERT INTO `migrations` VALUES (19,'2023_04_05_011333_create_categories_table',1);
INSERT INTO `migrations` VALUES (20,'2023_04_10_105544_create_authors_table',1);
INSERT INTO `migrations` VALUES (21,'2023_04_11_104611_create_books_table',1);
INSERT INTO `migrations` VALUES (22,'2023_04_14_120841_create_comments_table',1);
INSERT INTO `migrations` VALUES (23,'2023_04_15_090309_create_requests_table',1);
